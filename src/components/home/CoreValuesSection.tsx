    ...
    <section ref={ref} className="section-padding bg-background relative overflow-hidden">
      <div className="section-container relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          <span
            className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold uppercase tracking-wide mb-6 transition-all duration-600 bg-accent/15 text-accent ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.slice(0, 3).map((value, index) => (
            <div
              key={value.title}
              className={`group relative overflow-hidden rounded-2xl bg-card border border-border/50 p-8 lg:p-10 text-center shadow-sm hover:shadow-xl transition-all duration-500 ease-out hover:-translate-y-2 ${
            ...
            >
              ...
              <div className="w-16 h-16 mx-auto bg-accent rounded-2xl flex items-center justify-center mb-7 shadow-md transition-all duration-400 group-hover:scale-110 group-hover:shadow-lg">
