        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button 
              ...
              className="h-10 sm:h-11 px-5 font-semibold text-sm rounded-md shadow-md transition-all duration-200 flex items-center justify-center gap-2 bg-[hsl(45,100%,51%)] text-[hsl(0,0%,13%)] hover:bg-[hsl(45,100%,45%)] hover:shadow-lg disabled:opacity-50 disabled:hover:bg-[hsl(45,100%,51%)] active:scale-[0.98]"
            >
              Track Now
              <ArrowRight size={14} />
            </button>
