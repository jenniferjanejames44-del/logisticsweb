      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 relative z-10 pt-28 sm:pt-32 pb-16 md:py-32">
        <div className="max-w-[600px] mx-auto text-center lg:text-left lg:mx-0">
          ...
          <div className={`flex flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-10 transition-all duration-500 delay-200 ${
            ...
            <Link 
              to="/pricing"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 font-extrabold text-sm sm:text-base rounded-full shadow-md transition-all duration-200 bg-[hsl(45,100%,51%)] text-[hsl(0,0%,13%)] hover:bg-[hsl(45,100%,45%)] hover:shadow-lg hover:-translate-y-0.5 active:scale-[0.98]"
            >
              Get Quote
            ...
            <Link 
              to="/auth"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 font-extrabold text-sm sm:text-base rounded-full shadow-sm transition-all duration-200 bg-white text-primary hover:bg-primary hover:text-white hover:shadow-md active:scale-[0.98]"
            >
              Sign Up
              <ArrowRight className="w-4 h-4" />
            </Link>
