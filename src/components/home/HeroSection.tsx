    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 relative z-10 pt-28 sm:pt-36 pb-12 md:py-36">
        <div className="max-w-[700px] mx-auto text-center lg:text-left lg:mx-0">
          ...
          {/* CTA Buttons */}
          <div className={`flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8 sm:mb-12 transition-all duration-500 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}>
            <Link 
              to="/pricing"
              className="inline-flex items-center justify-center gap-2 h-12 sm:h-14 px-6 sm:px-10 font-bold text-sm sm:text-base rounded-full shadow-lg transition-all duration-200 bg-[hsl(45,100%,51%)] text-[hsl(0,0%,13%)] hover:bg-[hsl(45,100%,45%)] hover:shadow-xl hover:-translate-y-1 active:scale-[0.98] w-full sm:w-auto"
            >
              Get Quote
