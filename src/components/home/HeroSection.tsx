      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 relative z-10 pt-28 sm:pt-32 pb-16 md:py-32">
        <div className="max-w-[600px] mx-auto text-center lg:text-left lg:mx-0">
          ...
          <div className={`flex flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-10 sm:mb-14 transition-all duration-700 delay-200 ${
            ...
            <Link 
              to="/pricing"
              className="inline-flex items-center gap-2.5 px-7 sm:px-8 py-3.5 sm:py-4 font-bold text-sm sm:text-base rounded-xl transition-all duration-300 ease-out bg-secondary text-primary shadow-lg hover:shadow-xl hover:bg-[hsl(38,100%,55%)] hover:-translate-y-1 active:translate-y-0 active:shadow-md group uppercase tracking-wide"
            >
              Get Quote
