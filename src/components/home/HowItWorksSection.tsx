      ...
      <div className="section-container relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              {/* Card */}
              <div className="glass-card card-top-border h-full p-8 relative overflow-hidden">
                {/* Step Number */}
                <div className="absolute top-6 right-6 w-10 h-10 gradient-orange rounded-lg flex items-center justify-center font-bold text-sm text-white shadow-lg">
                  {step.step}
                </div>

                {/* Icon */}
                <div className="w-14 h-14 gradient-orange rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
