  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 select-none rounded-full",
  {
    variants: {
      variant: {
        ...
        default: "bg-accent text-accent-foreground hover:bg-[hsl(var(--accent-orange-hover))] hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_12px_28px_rgba(223,81,1,0.18)] hover:shadow-[0_18px_38px_rgba(223,81,1,0.24)]",

        /* SECONDARY BUTTON - Outline Navy */
        secondary: "bg-background text-primary border border-primary/12 hover:bg-primary/5 hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_10px_24px_rgba(15,23,42,0.06)]",

        /* ACCENT BUTTON - Alias of primary CTA */
        accent: "bg-accent text-accent-foreground hover:bg-[hsl(var(--accent-orange-hover))] hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_12px_28px_rgba(223,81,1,0.18)] font-semibold",

        /* Ghost Button */
        ghost: "bg-transparent text-muted-foreground hover:bg-muted hover:text-foreground active:scale-[0.98]",

        /* Outline - Navy border */
        outline: "bg-background/95 text-primary border border-primary/15 hover:bg-primary/5 hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_8px_24px_rgba(15,23,42,0.04)]",
        ...
        /* Navigation variants */
        nav: "bg-primary text-primary-foreground hover:bg-[hsl(var(--primary-hover))] hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_12px_30px_rgba(6,16,67,0.18)]",
        navSecondary: "bg-background text-primary border border-primary/12 hover:bg-primary/5 hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_10px_26px_rgba(15,23,42,0.05)]",
        navOutline: "bg-transparent text-primary border border-primary/20 hover:bg-primary/5 hover:-translate-y-0.5 active:scale-[0.98]",

        /* Hero variants */
        heroPrimary: "bg-accent text-accent-foreground shadow-[0_14px_34px_rgba(223,81,1,0.2)] hover:bg-[hsl(var(--accent-orange-hover))] hover:shadow-[0_20px_40px_rgba(223,81,1,0.26)] hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0",
        heroSecondary: "bg-background text-primary border border-white/50 shadow-[0_12px_30px_rgba(255,255,255,0.12)] hover:bg-white hover:text-primary hover:shadow-[0_18px_34px_rgba(255,255,255,0.16)] hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0",
        ...
        cta: "bg-accent text-accent-foreground shadow-[0_14px_34px_rgba(223,81,1,0.2)] hover:bg-[hsl(var(--accent-orange-hover))] hover:shadow-[0_20px_40px_rgba(223,81,1,0.24)] hover:-translate-y-0.5 active:scale-[0.98] active:translate-y-0",
        navCta: "bg-accent text-accent-foreground hover:bg-[hsl(var(--accent-orange-hover))] hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_12px_28px_rgba(223,81,1,0.2)]",
        ctaOutline: "bg-background text-primary border border-primary/15 hover:bg-primary/5 hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_10px_24px_rgba(15,23,42,0.05)]",
