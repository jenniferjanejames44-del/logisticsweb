...
<tr class="dispatch-note"><td style="padding:0 4px 10px;font-size:11px;color:#778093;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="left" style="font-weight:700;letter-spacing:.08em;text-transform:uppercase;">RAC Logistics</td><td align="right">Trusted global freight</td></tr></table></td></tr>
...
<tr><td class="email-header" style="background:${primary_color};padding:24px 38px;border-bottom:3px solid ${accent_color};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="left"><img class="email-logo" src="${escapeHtml(logo_url)}" alt="RAC Logistics" width="128" style="display:block;width:128px;max-width:100%;height:auto;border:0;outline:0;color:#ffffff;font-size:14px;font-weight:800;filter:brightness(0) invert(1);"/></td><td align="right" class="brand-tagline" style="font-size:11px;color:#d8dceb;letter-spacing:.06em;text-transform:uppercase;">${escapeHtml(slogan)}</td></tr></table></td></tr>
