...
<tr><td style="background:${primary_color};padding:26px 38px;border-bottom:4px solid ${accent_color};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="left"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="background:#ffffff;border-radius:6px;padding:7px 11px;"><img src="${escapeHtml(logo_url)}" alt="RAC Logistics" width="178" style="display:block;width:178px;max-width:100%;height:auto;border:0;outline:0;color:${primary_color};font-size:16px;font-weight:800;"/></td></tr></table></td><td align="right" class="brand-tagline" style="font-size:11px;color:#d8dceb;letter-spacing:.06em;text-transform:uppercase;">${escapeHtml(slogan)}</td></tr></table></td></tr>
